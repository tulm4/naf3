...
func walkRewriteSpecs(d *openapi.Document, refs map[string]struct{}) error {
...
func (s *walkRewriteSpecsType) walkAdditionalProperties(v *openapi.AdditionalProperties) error {
...
func (s *walkRewriteSpecsType) walkCallbackRef(v *openapi.Ref[openapi.Callback]) error {
	if _, exist := s.visited[v]; exist {
		return nil
	}
	s.visited[v] = struct{}{}
...
func (s *walkRewriteSpecsType) walkComponents(v *openapi.Components) error {
	if _, exist := s.visited[v]; exist {
		return nil
	}
	s.visited[v] = struct{}{}
...
func (s *walkRewriteSpecsType) walkDocument(v *openapi.Document) error {
	if _, exist := s.visited[v]; exist {
		return nil
	}
	s.visited[v] = struct{}{}
...
func (s *walkRewriteSpecsType) walkEncoding(v *openapi.Encoding) error {
	if _, exist := s.visited[v]; exist {
		return nil
	}
	s.visited[v] = struct{}{}
...
func (s *walkRewriteSpecsType) walkExampleRef(v *openapi.Ref[openapi.Example]) error {
	if _, exist := s.visited[v]; exist {
		return nil
	}
	s.visited[v] = struct{}{}
...
func (s *walkRewriteSpecsType) walkHeader(v *openapi.Header) error {
	if _, exist := s.visited[v]; exist {
		return nil
	}
	s.visited[v] = struct{}{}
...
func (s *walkRewriteSpecsType) walkHeaderRef(v *openapi.Ref[openapi.Header]) error {
	if _, exist := s.visited[v]; exist {
		return nil
	}
	s.visited[v] = struct{}{}
...
func (s *walkRewriteSpecsType) walkLinkRef(v *openapi.Ref[openapi.Link]) error {
	if _, exist := s.visited[v]; exist {
		return nil
	}
	s.visited[v] = struct{}{}
...
func (s *walkRewriteSpecsType) walkMediaType(v *openapi.MediaType) error {
	if _, exist := s.visited[v]; exist {
		return nil
	}
	s.visited[v] = struct{}{}
...
func (s *walkRewriteSpecsType) walkNodeRef(v *openapi.Ref[yaml.Node]) error {
	if _, exist := s.visited[v]; exist {
		return nil
	}
	s.visited[v] = struct{}{}
...
func (s *walkRewriteSpecsType) walkOperation(v *openapi.Operation) error {
	if _, exist := s.visited[v]; exist {
		return nil
	}
	s.visited[v] = struct{}{}
...
func (s *walkRewriteSpecsType) walkParameter(v *openapi.Parameter) error {
	if _, exist := s.visited[v]; exist {
		return nil
	}
	s.visited[v] = struct{}{}
...
func (s *walkRewriteSpecsType) walkParameterRef(v *openapi.Ref[openapi.Parameter]) error {
	if _, exist := s.visited[v]; exist {
		return nil
	}
	s.visited[v] = struct{}{}
...
func (s *walkRewriteSpecsType) walkPathItemBase(v *openapi.PathItemBase) error {
	if _, exist := s.visited[v]; exist {
		return nil
	}
	s.visited[v] = struct{}{}
...
func (s *walkRewriteSpecsType) walkPathItemBaseRef(v *openapi.Ref[openapi.PathItemBase]) error {
	if _, exist := s.visited[v]; exist {
		return nil
	}
	s.visited[v] = struct{}{}
...
func (s *walkRewriteSpecsType) walkRequestBody(v *openapi.RequestBody) error {
	if _, exist := s.visited[v]; exist {
		return nil
	}
	s.visited[v] = struct{}{}
...
func (s *walkRewriteSpecsType) walkRequestBodyRef(v *openapi.Ref[openapi.RequestBody]) error {
	if _, exist := s.visited[v]; exist {
		return nil
	}
	s.visited[v] = struct{}{}
...
func (s *walkRewriteSpecsType) walkResponse(v *openapi.Response) error {
	if _, exist := s.visited[v]; exist {
		return nil
	}
	s.visited[v] = struct{}{}
...
func (s *walkRewriteSpecsType) walkResponseRef(v *openapi.Ref[openapi.Response]) error {
	if _, exist := s.visited[v]; exist {
		return nil
	}
	s.visited[v] = struct{}{}
...
func (s *walkRewriteSpecsType) walkSchema(v *openapi.Schema) error {
	if _, exist := s.visited[v]; exist {
		return nil
	}
	s.visited[v] = struct{}{}
...
func (s *walkRewriteSpecsType) walkSchemaRef(v *openapi.Ref[openapi.Schema]) error {
	if _, exist := s.visited[v]; exist {
		return nil
	}
	s.visited[v] = struct{}{}
