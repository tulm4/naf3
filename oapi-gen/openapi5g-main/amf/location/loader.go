...
import (
	...
	"github.com/ShouheiNishi/openapi5g/internal/embed/TS29515_Ngmlc_Location"
	...
	"github.com/ShouheiNishi/openapi5g/internal/embed/TS29518_Namf_Location"
...
var specTable map[string][]byte = map[string][]byte{
	...
	"TS29515_Ngmlc_Location.yaml":            TS29515_Ngmlc_Location.SpecYaml,
	...
	"TS29518_Namf_Location.yaml":             TS29518_Namf_Location.SpecYaml,
...
func (s loaderType) RootSpecName() string {
	return "TS29518_Namf_Location.yaml"
}
