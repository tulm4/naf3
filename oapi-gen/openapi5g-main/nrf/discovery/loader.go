...
import (
	...
	"github.com/ShouheiNishi/openapi5g/internal/embed/TS29510_Nnrf_NFDiscovery"
...
var specTable map[string][]byte = map[string][]byte{
	...
	"TS29510_Nnrf_NFDiscovery.yaml":          TS29510_Nnrf_NFDiscovery.SpecYaml,
...
func (s loaderType) RootSpecName() string {
	return "TS29510_Nnrf_NFDiscovery.yaml"
}
