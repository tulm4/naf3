...
import (
	...
	"github.com/ShouheiNishi/openapi5g/internal/embed/TS29531_Nnssf_NSSAIAvailability"
...
var specTable map[string][]byte = map[string][]byte{
	...
	"TS29531_Nnssf_NSSAIAvailability.yaml":   TS29531_Nnssf_NSSAIAvailability.SpecYaml,
...
func (s loaderType) RootSpecName() string {
	return "TS29531_Nnssf_NSSAIAvailability.yaml"
}
