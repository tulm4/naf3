...
import (
	...
	"github.com/ShouheiNishi/openapi5g/internal/embed/TS29525_Npcf_UEPolicyControl"
...
var specTable map[string][]byte = map[string][]byte{
	...
	"TS29525_Npcf_UEPolicyControl.yaml":      TS29525_Npcf_UEPolicyControl.SpecYaml,
...
func (s loaderType) RootSpecName() string {
	return "TS29525_Npcf_UEPolicyControl.yaml"
}
