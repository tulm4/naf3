...
import (
	...
	"github.com/ShouheiNishi/openapi5g/internal/embed/TS29509_Nausf_UEAuthentication"
...
var specTable map[string][]byte = map[string][]byte{
	...
	"TS29509_Nausf_UEAuthentication.yaml":    TS29509_Nausf_UEAuthentication.SpecYaml,
...
func (s loaderType) RootSpecName() string {
	return "TS29509_Nausf_UEAuthentication.yaml"
}
